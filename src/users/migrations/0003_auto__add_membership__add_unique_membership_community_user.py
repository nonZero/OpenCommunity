...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'users_membership', (
            ...
            ('community', self.gf('django.db.models.fields.related.ForeignKey')(related_name='members', to=orm['communities.Community'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='communities', to=orm['users.OCUser'])),
    ...
    models = {
        ...
        u'users.membership': {
            ...
            'community': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'members'", 'to': u"orm['communities.Community']"}),
            'default_group_name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'communities'", 'to': u"orm['users.OCUser']"})
        },
        u'users.ocuser': {
