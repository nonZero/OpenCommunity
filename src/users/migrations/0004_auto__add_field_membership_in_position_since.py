...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Membership.in_position_since'
        db.add_column(u'users_membership', 'in_position_since',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 1, 1, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Membership.in_position_since'
        db.delete_column(u'users_membership', 'in_position_since')
    ...
    models = {
        ...
        u'communities.community': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'84qpddyqh3yzuuqsawhby409'", 'unique': 'True', 'max_length': '24'}),
        ...
        u'users.invitation': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'mobfohk4hhmiz1whx4qsbs5as2duk5ktzoriv8sya1ljo495'", 'max_length': '48'}),
