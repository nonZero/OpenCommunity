...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Meeting.created_by'
        db.alter_column(u'meetings_meeting', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.OCUser']))

    def backwards(self, orm):

        # Changing field 'Meeting.created_by'
        db.alter_column(u'meetings_meeting', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
