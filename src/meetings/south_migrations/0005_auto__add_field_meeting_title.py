...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'meetings_meeting', 'title',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'meetings_meeting', 'title')
    ...
    models = {
        ...
        u'communities.community': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'hblq41ep6e2dcwrnd0jouuze'", 'unique': 'True', 'max_length': '24'}),
        ...
        u'issues.issue': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'eu1w1fyuj45fuwsfh3puf8js'", 'unique': 'True', 'max_length': '24'})
        },
        ...
        u'meetings.meeting': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'qcbedpfdjss5lkrgt0kvx6cv'", 'unique': 'True', 'max_length': '24'})
        },
