...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AgendaItem.background'
        db.add_column(u'meetings_agendaitem', 'background',
                      self.gf('ocd.base_models.HTMLField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AgendaItem.background'
        db.delete_column(u'meetings_agendaitem', 'background')
    ...
    models = {
        ...
        u'communities.community': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'9ulxemk2ppwphest9mzfhshr'", 'unique': 'True', 'max_length': '24'}),
        ...
        u'issues.issue': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'ypus3xddtg44lo8gn8xje33v'", 'unique': 'True', 'max_length': '24'})
        },
        ...
        u'meetings.meeting': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'mfuemn8ct9arg5eqm36ynfd1'", 'unique': 'True', 'max_length': '24'})
        },
