...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Meeting.uid'
        db.alter_column(u'meetings_meeting', 'uid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=24))
        # Adding unique constraint on 'Meeting', fields ['uid']
        db.create_unique(u'meetings_meeting', ['uid'])


    def backwards(self, orm):
        # Removing unique constraint on 'Meeting', fields ['uid']
        db.delete_unique(u'meetings_meeting', ['uid'])


        # Changing field 'Meeting.uid'
        db.alter_column(u'meetings_meeting', 'uid', self.gf('django.db.models.fields.CharField')(max_length=24, null=True))
    ...
    models = {
        ...
        u'communities.community': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'nn0vtft60hn2i2erbqi6oi0e'", 'unique': 'True', 'max_length': '24'}),
        ...
        u'issues.issue': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'vccjpqbg03ip8eaeb731gllr'", 'unique': 'True', 'max_length': '24'})
        },
        ...
        u'meetings.meeting': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'g1goabstocfa9l6d5c5038aw'", 'unique': 'True', 'max_length': '24'})
        },
