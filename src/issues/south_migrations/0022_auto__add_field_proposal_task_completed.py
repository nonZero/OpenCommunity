...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Proposal.task_completed'
        db.add_column(u'issues_proposal', 'task_completed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Proposal.task_completed'
        db.delete_column(u'issues_proposal', 'task_completed')
    ...
    models = {
        ...
        u'communities.community': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'ntglvigest83rfbj9ebe7vfv'", 'unique': 'True', 'max_length': '24'}),
        ...
        u'issues.issue': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'ofho3nd77aoqezh29b6d22gf'", 'unique': 'True', 'max_length': '24'})
        },
        u'issues.issueattachment': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'4gm33eyi374lj0pwc3kirjag'", 'unique': 'True', 'max_length': '24'})
        },
        u'issues.issuecomment': {
            ...
            'ordinal': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'uid': ('django.db.models.fields.CharField', [], {'default': "'nx6cvnrnvz67dglpcesmy33z'", 'unique': 'True', 'max_length': '24'}),
        ...
        u'issues.proposal': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'d4jcbgat3pezsi0wfwx7y9nt'", 'unique': 'True', 'max_length': '24'}),
        ...
        u'meetings.meeting': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'mc05x4mkvwsj9iftxlgme65n'", 'unique': 'True', 'max_length': '24'})
        },
