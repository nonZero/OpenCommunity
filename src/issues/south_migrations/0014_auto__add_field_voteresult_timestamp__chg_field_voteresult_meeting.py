...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'VoteResult', fields ['proposal', 'meeting']
        db.create_unique(u'issues_voteresult', ['proposal_id', 'meeting_id'])

        # Adding field 'Proposal.votes_pro'
        db.add_column(u'issues_proposal', 'votes_pro',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Proposal.votes_con'
        db.add_column(u'issues_proposal', 'votes_con',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Proposal.community_members'
        db.add_column(u'issues_proposal', 'community_members',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'VoteResult', fields ['proposal', 'meeting']
        db.delete_unique(u'issues_voteresult', ['proposal_id', 'meeting_id'])

        # Deleting field 'Proposal.votes_pro'
        db.delete_column(u'issues_proposal', 'votes_pro')

        # Deleting field 'Proposal.votes_con'
        db.delete_column(u'issues_proposal', 'votes_con')

        # Deleting field 'Proposal.community_members'
        db.delete_column(u'issues_proposal', 'community_members')
    ...
    models = {
        ...
        u'communities.community': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'pa4wwdghm1c17wbi78kpypce'", 'unique': 'True', 'max_length': '24'}),
        ...
        u'issues.issue': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'s30s5ad4j312pcegwtxkwuvp'", 'unique': 'True', 'max_length': '24'})
        },
        u'issues.issueattachment': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'nku6cr7jwkcup34a44dyi52d'", 'unique': 'True', 'max_length': '24'})
        },
        u'issues.issuecomment': {
            ...
            'ordinal': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'uid': ('django.db.models.fields.CharField', [], {'default': "'2ft8orju5pt53hbkcnmg21j8'", 'unique': 'True', 'max_length': '24'}),
        ...
        u'issues.proposal': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'279wcnz95y522a12oiw827f9'", 'unique': 'True', 'max_length': '24'}),
        ...
        u'meetings.meeting': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'hzn0om0wp7xb6lzxa9t16727'", 'unique': 'True', 'max_length': '24'})
        },
