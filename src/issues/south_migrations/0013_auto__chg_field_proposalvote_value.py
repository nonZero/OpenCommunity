...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProposalVote.value'
        db.alter_column(u'issues_proposalvote', 'value', self.gf('django.db.models.fields.SmallIntegerField')())

    def backwards(self, orm):

        # Changing field 'ProposalVote.value'
        db.alter_column(u'issues_proposalvote', 'value', self.gf('django.db.models.fields.PositiveIntegerField')())
    ...
    models = {
        ...
        u'communities.community': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'7tici3t8186o2a7afn29b4yy'", 'unique': 'True', 'max_length': '24'}),
        ...
        u'issues.issue': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'zwjy3zwug8tduy1avtb4a1pq'", 'unique': 'True', 'max_length': '24'})
        },
        u'issues.issueattachment': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'t4rka4xa2epbq6327yyyxw6t'", 'unique': 'True', 'max_length': '24'})
        },
        u'issues.issuecomment': {
            ...
            'ordinal': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'uid': ('django.db.models.fields.CharField', [], {'default': "'fnm8ef5xysil4efmdyfvi6y7'", 'unique': 'True', 'max_length': '24'}),
        ...
        u'issues.proposal': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'u3zvdzg5qnajqnxeh9mzkweh'", 'unique': 'True', 'max_length': '24'}),
        ...
        u'meetings.meeting': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'zmwfue5c5uxaixylfb3fqyka'", 'unique': 'True', 'max_length': '24'})
        },
