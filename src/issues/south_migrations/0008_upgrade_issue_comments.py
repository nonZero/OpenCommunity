...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for c in orm['issues.IssueComment'].objects.all():
            if c.issue.is_closed:
                c.meeting = c.issue.closed_at_meeting
                print "comment #%d closed at meeting %d" % (c.id, c.meeting.id)
                c.save()
                continue

            print "comment #%d still open." % c.id
    ...
    models = {
        ...
        u'communities.community': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'lmafqxijzuzp23ssa2duzou2'", 'unique': 'True', 'max_length': '24'}),
        ...
        u'issues.issue': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'wemeiqgb52j08b8f4ygsk40e'", 'unique': 'True', 'max_length': '24'})
        },
        u'issues.issuecomment': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'kg2rnd4jfoa9w23teibwsbyc'", 'unique': 'True', 'max_length': '24'}),
        ...
        u'issues.proposal': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'71thhibzgyuygpzedh96m1ur'", 'unique': 'True', 'max_length': '24'}),
        ...
        u'meetings.meeting': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'k8tqjf13fft8y2xzdrgcygnc'", 'unique': 'True', 'max_length': '24'})
        },
