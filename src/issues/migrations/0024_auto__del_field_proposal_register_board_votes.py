...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Proposal.register_board_votes'
        db.delete_column(u'issues_proposal', 'register_board_votes')


    def backwards(self, orm):
        # Adding field 'Proposal.register_board_votes'
        db.add_column(u'issues_proposal', 'register_board_votes',
    ...
    models = {
        ...
        u'communities.community': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'gl55f0c8w870lxlytbjgc516'", 'unique': 'True', 'max_length': '24'}),
        ...
        u'issues.issue': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'zvmxrp74wvpa65gx4haqd2di'", 'unique': 'True', 'max_length': '24'})
        },
        u'issues.issueattachment': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'7okxjj7labe78olmao32o3li'", 'unique': 'True', 'max_length': '24'})
        },
        u'issues.issuecomment': {
            ...
            'ordinal': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'uid': ('django.db.models.fields.CharField', [], {'default': "'uhiw55md33c75ywprk8i6qpl'", 'unique': 'True', 'max_length': '24'}),
        ...
        u'issues.proposal': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'k6yp9m0rekcjs3fiplz1onk9'", 'unique': 'True', 'max_length': '24'}),
        ...
        u'meetings.meeting': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'ajm6vyil0al5435ktt3x0r7d'", 'unique': 'True', 'max_length': '24'})
        },
