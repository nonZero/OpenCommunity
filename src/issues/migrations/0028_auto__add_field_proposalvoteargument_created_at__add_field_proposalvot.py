...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProposalVoteArgument.created_at'
        db.add_column(u'issues_proposalvoteargument', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date.today(), blank=True),
                      keep_default=False)

        # Adding field 'ProposalVoteArgument.created_by'
        db.add_column(u'issues_proposalvoteargument', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='arguments_created', to=orm['users.OCUser']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProposalVoteArgument.created_at'
        db.delete_column(u'issues_proposalvoteargument', 'created_at')

        # Deleting field 'ProposalVoteArgument.created_by'
        db.delete_column(u'issues_proposalvoteargument', 'created_by_id')
    ...
    models = {
        ...
        u'communities.community': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'yagkj3ygcj1i8jndh6o5dkek'", 'unique': 'True', 'max_length': '24'}),
        ...
        u'issues.issue': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'ighcvl8bwkgnlq3hebop20r0'", 'unique': 'True', 'max_length': '24'})
        },
        u'issues.issueattachment': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'r3tvmcoobgd7bmb0gcvdj847'", 'unique': 'True', 'max_length': '24'})
        },
        u'issues.issuecomment': {
            ...
            'ordinal': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'uid': ('django.db.models.fields.CharField', [], {'default': "'ds7ss7p2jilwl31k6m7hn8ky'", 'unique': 'True', 'max_length': '24'}),
        ...
        u'issues.proposal': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'0s4vpbm2ia3j31ghrktj0u00'", 'unique': 'True', 'max_length': '24'}),
        ...
        u'issues.proposalvoteargument': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'arguments_created'", 'to': u"orm['users.OCUser']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'meetings.meeting': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'ozu2qthko96i6t8jcatcziy0'", 'unique': 'True', 'max_length': '24'})
        },
