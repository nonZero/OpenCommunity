...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Issue.in_upcoming_meeting'
        db.delete_column(u'issues_issue', 'in_upcoming_meeting')

        # Deleting field 'Issue.closed_at_meeting'
        db.delete_column(u'issues_issue', 'closed_at_meeting_id')

        # Deleting field 'Issue.is_closed'
        db.delete_column(u'issues_issue', 'is_closed')

        # Deleting field 'Proposal.accepted_at'
        db.delete_column(u'issues_proposal', 'accepted_at')

        # Deleting field 'Proposal.is_accepted'
        db.delete_column(u'issues_proposal', 'is_accepted')


    def backwards(self, orm):
        # Adding field 'Issue.in_upcoming_meeting'
        db.add_column(u'issues_issue', 'in_upcoming_meeting',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Issue.closed_at_meeting'
        db.add_column(u'issues_issue', 'closed_at_meeting',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['meetings.Meeting'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Issue.is_closed'
        db.add_column(u'issues_issue', 'is_closed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Proposal.accepted_at'
        db.add_column(u'issues_proposal', 'accepted_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Proposal.is_accepted'
        db.add_column(u'issues_proposal', 'is_accepted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    models = {
        ...
        u'communities.community': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'x7yhtqx0lohfbf4hozhgx3mj'", 'unique': 'True', 'max_length': '24'}),
        ...
        u'issues.issue': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'vq6owe6yddgi65yp4fsnssu2'", 'unique': 'True', 'max_length': '24'})
        },
        u'issues.issuecomment': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'bh9gm5bsm3ci8uqqmgs3kvns'", 'unique': 'True', 'max_length': '24'}),
        ...
        u'issues.proposal': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'c1mf1k6fs5eurduq5iqnud9a'", 'unique': 'True', 'max_length': '24'}),
        ...
        u'meetings.meeting': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'74n8u34nnwdfz6dd3u5mxx50'", 'unique': 'True', 'max_length': '24'})
        },
