...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Issue.length_in_minutes'
        db.add_column(u'issues_issue', 'length_in_minutes',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Issue.length_in_minutes'
        db.delete_column(u'issues_issue', 'length_in_minutes')
