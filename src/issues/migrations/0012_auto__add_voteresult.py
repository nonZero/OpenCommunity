...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VoteResult'
        db.create_table(u'issues_voteresult', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('proposal', self.gf('django.db.models.fields.related.ForeignKey')(related_name='results', to=orm['issues.Proposal'])),
            ('meeting', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['meetings.Meeting'])),
            ('votes_pro', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('votes_con', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('community_members', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal(u'issues', ['VoteResult'])


    def backwards(self, orm):
        # Deleting model 'VoteResult'
        db.delete_table(u'issues_voteresult')
    ...
    models = {
        ...
        u'communities.community': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'haa1vidlpyvi4wg6auwvjch9'", 'unique': 'True', 'max_length': '24'}),
        ...
        u'issues.issue': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'vgbcvw1x8qsbqwaqxxmui72x'", 'unique': 'True', 'max_length': '24'})
        },
        u'issues.issueattachment': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'uks9ehz0qeddy497ylj87i9d'", 'unique': 'True', 'max_length': '24'})
        },
        u'issues.issuecomment': {
            ...
            'ordinal': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'uid': ('django.db.models.fields.CharField', [], {'default': "'nskxy7i9be0ayde5apx8ilp2'", 'unique': 'True', 'max_length': '24'}),
        ...
        u'issues.proposal': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'7e4r8iqis0oqs8c2r1nj0q64'", 'unique': 'True', 'max_length': '24'}),
        ...
        u'meetings.meeting': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'h0a1v0q24c93tqfb4ne4veol'", 'unique': 'True', 'max_length': '24'})
        },
