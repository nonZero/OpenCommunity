...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'issues_proposal', 'status',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Proposal.decided_at_meeting'
        db.add_column(u'issues_proposal', 'decided_at_meeting',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'issues_issue', 'status')

        # Deleting field 'Proposal.status'
        db.delete_column(u'issues_proposal', 'status')

        # Deleting field 'Proposal.decided_at_meeting'
        db.delete_column(u'issues_proposal', 'decided_at_meeting_id')
    ...
    models = {
        ...
        u'communities.community': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'c3ykzh5j5buqfdlyna50wrxm'", 'unique': 'True', 'max_length': '24'}),
        ...
        u'issues.issue': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'l0j06pmna9frwa7fl5aqfqh1'", 'unique': 'True', 'max_length': '24'})
        },
        u'issues.issuecomment': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'xt94lmwvthho2uze1qjou4ba'", 'unique': 'True', 'max_length': '24'}),
        ...
        u'issues.proposal': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'8bjscy151wl2uzus038s76t5'", 'unique': 'True', 'max_length': '24'}),
        ...
        u'meetings.meeting': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'xv0i2sa7vnlcsx4cdnvgedbu'", 'unique': 'True', 'max_length': '24'})
        },
