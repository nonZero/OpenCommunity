...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'issues_issueattachment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('uid', self.gf('django.db.models.fields.CharField')(default='a513mhhuetjg8b21ckesg8z8', unique=True, max_length=24)),
            ...
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='files_created', to=orm['users.OCUser'])),
        ))
        db.send_create_signal(u'issues', ['IssueAttachment'])


    def backwards(self, orm):
        # Deleting model 'IssueAttachment'
        db.delete_table(u'issues_issueattachment')
    ...
    models = {
        ...
        u'communities.community': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'jvk2hjjgti1seph1yt584tvy'", 'unique': 'True', 'max_length': '24'}),
        ...
        u'issues.issue': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'6ofrd7bqu71tq97v5tfx3dzt'", 'unique': 'True', 'max_length': '24'})
        },
        u'issues.issueattachment': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'xfbtsusvkrin0h8zc9iihagp'", 'unique': 'True', 'max_length': '24'})
        },
        u'issues.issuecomment': {
            ...
            'ordinal': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'uid': ('django.db.models.fields.CharField', [], {'default': "'j3tfci01y4qrg0u2trnm1jad'", 'unique': 'True', 'max_length': '24'}),
        ...
        u'issues.proposal': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'h4fx1jba8zsa4hhn0w5rqpvb'", 'unique': 'True', 'max_length': '24'}),
        ...
        u'meetings.meeting': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'8pwcn084jqd2sl2cbjmvns66'", 'unique': 'True', 'max_length': '24'})
        },
