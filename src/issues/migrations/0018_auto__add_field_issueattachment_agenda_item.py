...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'issues_issueattachment', 'agenda_item',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='attachments', null=True, to=orm['meetings.AgendaItem']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IssueAttachment.agenda_item'
        db.delete_column(u'issues_issueattachment', 'agenda_item_id')
    ...
    models = {
        ...
        u'communities.community': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'34u1ohimdpi2rqy749g2925q'", 'unique': 'True', 'max_length': '24'}),
        ...
        u'issues.issue': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'0oqxfzpd2jhoic490lbayv3s'", 'unique': 'True', 'max_length': '24'})
        },
        u'issues.issueattachment': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'dun3g1n1oz3el4846a17zpba'", 'unique': 'True', 'max_length': '24'})
        },
        u'issues.issuecomment': {
            ...
            'ordinal': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'uid': ('django.db.models.fields.CharField', [], {'default': "'4e25dksyzxxg8z6schve8py7'", 'unique': 'True', 'max_length': '24'}),
        ...
        u'issues.proposal': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'aotq1ixmfw2fqsyn2i5gy9t9'", 'unique': 'True', 'max_length': '24'}),
        ...
        u'meetings.meeting': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'k5soxsmsfmnziutethzwalsg'", 'unique': 'True', 'max_length': '24'})
        },
