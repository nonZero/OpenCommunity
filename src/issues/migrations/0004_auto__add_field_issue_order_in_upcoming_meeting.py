...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Issue.order_in_upcoming_meeting'
        db.add_column(u'issues_issue', 'order_in_upcoming_meeting',
                      self.gf('django.db.models.fields.IntegerField')(default=9999, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Issue.order_in_upcoming_meeting'
        db.delete_column(u'issues_issue', 'order_in_upcoming_meeting')
