...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Issue.is_published'
        db.add_column(u'issues_issue', 'is_published',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Issue.is_published'
        db.delete_column(u'issues_issue', 'is_published')
    ...
    models = {
        ...
        u'communities.community': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'lzjyrc9rd2oi01bngk8c8uir'", 'unique': 'True', 'max_length': '24'}),
        ...
        u'issues.issue': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'jlcan0x89oi02uk4scvxcbgk'", 'unique': 'True', 'max_length': '24'})
        },
        u'issues.issuecomment': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'9rw4d4zz5m7brekb6k3qs88p'", 'unique': 'True', 'max_length': '24'}),
        ...
        u'issues.proposal': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'yv5cetzxwiizyhfdzay9313i'", 'unique': 'True', 'max_length': '24'}),
        ...
        u'meetings.meeting': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'dr4m9qc19yiowr5elx5vfxu6'", 'unique': 'True', 'max_length': '24'})
        },
