...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProposalVoteArgument'
        db.create_table(u'issues_proposalvoteargument', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('proposal_vote', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['issues.ProposalVote'])),
            ('argument', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'issues', ['ProposalVoteArgument'])

        # Adding model 'ProposalVoteArgumentRanking'
        db.create_table(u'issues_proposalvoteargumentranking', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('argument', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['issues.ProposalVoteArgument'])),
            ('value', self.gf('django.db.models.fields.SmallIntegerField')(default=0)),
        ))
        db.send_create_signal(u'issues', ['ProposalVoteArgumentRanking'])


    def backwards(self, orm):
        # Deleting model 'ProposalVoteArgument'
        db.delete_table(u'issues_proposalvoteargument')

        # Deleting model 'ProposalVoteArgumentRanking'
        db.delete_table(u'issues_proposalvoteargumentranking')
    ...
    models = {
        ...
        u'communities.community': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'22uujv2u68ou6674dp04qzsd'", 'unique': 'True', 'max_length': '24'}),
        ...
        u'issues.issue': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'lgoag9otbbgi250u1diit02d'", 'unique': 'True', 'max_length': '24'})
        },
        u'issues.issueattachment': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'qmj12gof01inql0ambondag0'", 'unique': 'True', 'max_length': '24'})
        },
        u'issues.issuecomment': {
            ...
            'ordinal': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'uid': ('django.db.models.fields.CharField', [], {'default': "'rb39opwwkt1txy8tfyg3l6wr'", 'unique': 'True', 'max_length': '24'}),
        ...
        u'issues.proposal': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'vqd9u20qfpy4gp7wud6gpzk8'", 'unique': 'True', 'max_length': '24'}),
        ...
        u'issues.proposalvoteargument': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'proposal_vote': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['issues.ProposalVote']"})
        },
        ...
        u'meetings.meeting': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'syz4tf8v9ge5hl19r0px5qg3'", 'unique': 'True', 'max_length': '24'})
        },
