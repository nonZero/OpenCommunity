...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IssueAttachment.file'
        db.alter_column(u'issues_issueattachment', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'IssueAttachment.file'
        db.alter_column(u'issues_issueattachment', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=100))
    ...
    models = {
        ...
        u'communities.community': {
            ...
            'order_ranking_enabled': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'z5gw6dki3c3ngg88rhevu5rw'", 'unique': 'True', 'max_length': '24'}),
        ...
        u'issues.issue': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'q7nmx17yzj158osqc908m78y'", 'unique': 'True', 'max_length': '24'})
        },
        u'issues.issueattachment': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'1vfdk30izzgyn9l3g1494xic'", 'unique': 'True', 'max_length': '24'})
        },
        u'issues.issuecomment': {
            ...
            'ordinal': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'uid': ('django.db.models.fields.CharField', [], {'default': "'cmrn3oe0x1425n2v46t93bdw'", 'unique': 'True', 'max_length': '24'}),
        ...
        u'issues.proposal': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'t2nljr3ydzp58k7i9pevzuec'", 'unique': 'True', 'max_length': '24'}),
        ...
        u'meetings.agendaitem': {
            'Meta': {'ordering': "('meeting__created_at',)", 'unique_together': "(('meeting', 'issue'),)", 'object_name': 'AgendaItem'},
        ...
        u'meetings.meeting': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'09twb2n9djtysk47lmuuszlt'", 'unique': 'True', 'max_length': '24'})
        },
