...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'IssueRankingVote'
        db.create_table(u'issues_issuerankingvote', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('voted_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.OCUser'])),
        ...
        db.send_create_signal(u'issues', ['IssueRankingVote'])


    def backwards(self, orm):
        # Deleting model 'IssueRankingVote'
        db.delete_table(u'issues_issuerankingvote')
    ...
    models = {
        ...
        u'communities.community': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'0t2asq4c5ve0closrf0x53wd'", 'unique': 'True', 'max_length': '24'}),
        ...
        u'issues.issue': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'b9kbs2ejjz8c467rj1fuh5ol'", 'unique': 'True', 'max_length': '24'})
        },
        u'issues.issueattachment': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'r6mwdnasdbllgxc22h25726r'", 'unique': 'True', 'max_length': '24'})
        },
        u'issues.issuecomment': {
            ...
            'ordinal': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'uid': ('django.db.models.fields.CharField', [], {'default': "'8a5h9n5yd8gj19t6qru2pzlw'", 'unique': 'True', 'max_length': '24'}),
        ...
        u'issues.proposal': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'gv0nwza99der9oz7jj2mcs3p'", 'unique': 'True', 'max_length': '24'}),
        ...
        u'meetings.meeting': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'uqp81e8jrrzf24e1r1ztbqxf'", 'unique': 'True', 'max_length': '24'})
        },
