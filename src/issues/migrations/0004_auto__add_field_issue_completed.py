...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Issue.completed'
        db.add_column(u'issues_issue', 'completed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Issue.completed'
        db.delete_column(u'issues_issue', 'completed')
    ...
    models = {
        ...
        u'communities.community': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'gb3mmvnz7jknawvg0n5l7w05'", 'unique': 'True', 'max_length': '24'}),
        ...
        u'issues.issue': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'cjt3zxmj71gg9ikjdqh707h3'", 'unique': 'True', 'max_length': '24'})
        },
        u'issues.issuecomment': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'axwbq318ljc9ntq93ljfgvqv'", 'unique': 'True', 'max_length': '24'}),
        ...
        u'issues.proposal': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'biqpzymyyb232xy56flmm4kj'", 'unique': 'True', 'max_length': '24'}),
        ...
        u'meetings.meeting': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'5jmhajvbe17bb0p6bzxeekfz'", 'unique': 'True', 'max_length': '24'})
        },
