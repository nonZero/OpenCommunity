...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Community.upcoming_meeting_title'
        db.add_column(u'communities_community', 'upcoming_meeting_title',
                      self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Community.upcoming_meeting_title'
        db.delete_column(u'communities_community', 'upcoming_meeting_title')
    ...
    models = {
        ...
        u'communities.community': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'6m7m7lvjryuqkvpauh50w3sp'", 'unique': 'True', 'max_length': '24'}),
