...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Community.upcoming_meeting_guests'
        db.add_column(u'communities_community', 'upcoming_meeting_guests',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Community.upcoming_meeting_guests'
        db.delete_column(u'communities_community', 'upcoming_meeting_guests')
