...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CommunityConfidentialReason'
        db.create_table(u'communities_communityconfidentialreason', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('community', self.gf('django.db.models.fields.related.ForeignKey')(related_name='confidential_reasons', to=orm['communities.Community'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'communities', ['CommunityConfidentialReason'])

        # Adding unique constraint on 'CommunityConfidentialReason', fields ['community', 'title']
        db.create_unique(u'communities_communityconfidentialreason', ['community_id', 'title'])


    def backwards(self, orm):
        # Removing unique constraint on 'CommunityConfidentialReason', fields ['community', 'title']
        db.delete_unique(u'communities_communityconfidentialreason', ['community_id', 'title'])

        # Deleting model 'CommunityConfidentialReason'
        db.delete_table(u'communities_communityconfidentialreason')
    ...
    models = {
        ...
        u'communities.community': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'s5x29out7tesmd1bwm95le5k'", 'unique': 'True', 'max_length': '24'}),
