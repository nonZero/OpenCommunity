...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for community in orm.Community.objects.all():
                for reason in settings.OPENCOMMUNITY_DEFAULT_CONFIDENTIAL_REASONS:
                    orm.CommunityConfidentialReason.objects.create(
                        community=community,
    ...
    models = {
        ...
        u'communities.community': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'4g7417ljtre2xzyrbujc9n2d'", 'unique': 'True', 'max_length': '24'}),
