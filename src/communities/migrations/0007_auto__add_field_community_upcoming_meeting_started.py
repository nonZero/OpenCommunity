...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Community.upcoming_meeting_started'
        db.add_column(u'communities_community', 'upcoming_meeting_started',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Community.upcoming_meeting_started'
        db.delete_column(u'communities_community', 'upcoming_meeting_started')
