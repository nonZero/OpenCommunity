...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Community.allow_links_in_emails'
        db.add_column(u'communities_community', 'allow_links_in_emails',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Community.allow_links_in_emails'
        db.delete_column(u'communities_community', 'allow_links_in_emails')
    ...
    models = {
        ...
        u'communities.community': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'tvmtr7fo3lsl7d72njuw4kan'", 'unique': 'True', 'max_length': '24'}),
