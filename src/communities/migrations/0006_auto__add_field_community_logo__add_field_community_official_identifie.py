...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Community.logo'
        db.add_column(u'communities_community', 'logo',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Community.official_identifier'
        db.add_column(u'communities_community', 'official_identifier',
                      self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Community.logo'
        db.delete_column(u'communities_community', 'logo')

        # Deleting field 'Community.official_identifier'
        db.delete_column(u'communities_community', 'official_identifier')
    ...
    models = {
        ...
        u'communities.community': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'cuh71acpv64w1k4g634t69y0'", 'unique': 'True', 'max_length': '24'}),
