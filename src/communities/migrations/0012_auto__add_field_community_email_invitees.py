...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Community.email_invitees'
        db.add_column(u'communities_community', 'email_invitees',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Community.email_invitees'
        db.delete_column(u'communities_community', 'email_invitees')
    ...
    models = {
        ...
        u'communities.community': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'m11l8ks78zrmeixkihxhd47i'", 'unique': 'True', 'max_length': '24'}),
