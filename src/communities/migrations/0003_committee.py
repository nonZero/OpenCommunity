    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(max_length=200, null=True, verbose_name=b'Friendly URL', blank=True)),
                ...
                ('community', models.ForeignKey(related_name='committees', to='communities.Community', null=True)),
                ('upcoming_meeting_participants', models.ManyToManyField(related_name='+', verbose_name='Participants in upcoming meeting', to=settings.AUTH_USER_MODEL, blank=True)),
            ],
            options={
