...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Community.has_issue_votes'
        db.add_column(u'communities_community', 'has_issue_votes',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Community.has_issue_votes'
        db.delete_column(u'communities_community', 'has_issue_votes')
    ...
    models = {
        ...
        u'communities.community': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'i6bpc19bgqa36te68zr0u968'", 'unique': 'True', 'max_length': '24'}),
