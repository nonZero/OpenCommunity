...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Community.board_name'
        db.add_column(u'communities_community', 'board_name',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Community.board_name'
        db.delete_column(u'communities_community', 'board_name')
