...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'communities_community', 'board_name', self.gf('django.db.models.fields.CharField')(default='board', max_length=200))
    ...
    models = {
        ...
        u'communities.community': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'qnle9fvdrvkdtmon1srp8qal'", 'unique': 'True', 'max_length': '24'}),
