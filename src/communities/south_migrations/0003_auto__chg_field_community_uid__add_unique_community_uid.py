...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Community', fields ['uid']
        db.create_unique(u'communities_community', ['uid'])


    def backwards(self, orm):
        # Removing unique constraint on 'Community', fields ['uid']
        db.delete_unique(u'communities_community', ['uid'])


        # Changing field 'Community.uid'
        db.alter_column(u'communities_community', 'uid', self.gf('django.db.models.fields.CharField')(max_length=24, null=True))
    ...
    models = {
        ...
        u'communities.community': {
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'7ftkcn996x9uuorluzql10ln'", 'unique': 'True', 'max_length': '24'}),
