...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Community.no_meetings_community'
        db.add_column(u'communities_community', 'no_meetings_community',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Community.no_meetings_community'
        db.delete_column(u'communities_community', 'no_meetings_community')
    ...
    models = {
        ...
        u'communities.community': {
            ...
            'no_meetings_community': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'uid': ('django.db.models.fields.CharField', [], {'default': "'hd6quesixgcde8cys1zokai5'", 'unique': 'True', 'max_length': '24'}),
